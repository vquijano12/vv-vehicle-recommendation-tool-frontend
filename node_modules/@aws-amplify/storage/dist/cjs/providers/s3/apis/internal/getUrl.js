...
const getUrl = async (amplify, input) => {
    ...
    if (operation === 'PUT') {
        return {
            url: await (0, s3data_1.getPresignedPutObjectUrl)({
                ...s3Config,
                ...
                ...(getUrlOptions?.contentDisposition && {
                    ContentDisposition: typeof getUrlOptions.contentDisposition === 'string'
                        ? getUrlOptions.contentDisposition
                        : (0, constructContentDisposition_1.constructContentDisposition)(getUrlOptions.contentDisposition),
                }),
